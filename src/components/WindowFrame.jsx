...
const WindowFrame = ({ title, children, x, y, width, height, maximized, minimized, id, onClose, onFocus, onPositionChange, onSizeChange, onToggleMaximize, onMinimize, isActive, isCalculator = false }) => {
  ...
  const containerStyle = { left: x, top: y, zIndex: isDragging || isResizing ? 1000 : 'auto' };
  const frameStyle = { width: width, height: height, display: minimized ? 'none' : 'flex' };
